            ...
            @foreach ($kategori as $ktg)
                <div class="col-md-3 mb-2">
                    <button class="btn btn-primary w-100" type="button" data-bs-toggle="collapse"
                        ...
                        aria-controls="kategori-{{ $ktg->id }}" style="border-radius: 50px">
                        {{ $ktg->nama }}
                    </button>
                </div>
            @endforeach
                                ...
                                <div class="col-md-3 mb-4">
                                    <div class="card h-100 d-flex flex-column">
                                        ...
                                        <div class="card-footer bg-white border-0 d-grid gap-2 px-2 pt-0">
                                            {{-- Detail Produk --}}
                                            <button class="btn btn-sm btn-outline-dark w-100" data-bs-toggle="modal"
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 d-flex flex-column">
                        ...
                        <div class="card-footer bg-white border-0 d-grid gap-2 px-2 pt-0">
                            ...
                            @else
                                <button type="button" class="btn btn-sm btn-outline-secondary w-100" onclick="showLoginAlert()">
                                    <i class="fas fa-cart-plus"></i> Masukkan ke Keranjang
                                </button>
                            @endauth
                            ...
                            @else
                                <button type="button" class="btn btn-sm btn-outline-primary w-100" onclick="showLoginAlert()">
                                    <i class="fas fa-bolt"></i> Pesan Sekarang
                                </button>
                            @endauth
                        </div>
